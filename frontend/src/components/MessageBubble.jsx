      ...
      >
        <div
          className={`relative flex flex-col justify-end gap-2 min-w-26 max-w-sm md:max-w-md p-1 rounded-xl ${
            message.sender === Cookies.get("token")
              ? "bg-[#1a1a1a] text-white rounded-br-none shadow-xl pl-2"
        ...
        >
          ...
          {message.reaction && (
            <div
              ...
              } bg-slate-900 border border-slate-700 rounded-full px-1.5 py-1.5 text-sm leading-none shadow-md select-none flex items-center justify-center pt-2`}
            >
              {message.reaction}
            </div>
          )}
